...
function ExistingComment({commentData}) {
    ...
    const handleBrainClick = () => {
        if (commentBrained) {
            DiscussionsApi.RemoveBrainFromComment(commentData.topicId, commentData.id, currentUser.id).then(success => {
                if (success) {
            ...
            DiscussionsApi.AddBrainToComment(commentData.topicId, commentData.id, currentUser.id).then(success => {
                if (success) {
